...
class ALBEF(nn.Module):
    ...
    def forward(self, image, text, alpha=0):
        ...
        text_output = self.text_encoder.encoder(text.input_ids, attention_mask = text.attention_mask,
        ...
        with torch.no_grad():
            ...
            text_output_m = self.text_encoder_m.encoder(text.input_ids, attention_mask = text.attention_mask, 
                                                return_dict = True, mode = 'text')    
